...
export default function ResourcePacksView(props: { service: InstanceService }) {
    ...
    <div className="p-3 space-y-3">
      <div className="flex space-x-3">
        ...
        <Button
          onClick={() =>
            invoke("reveal_path", {
              pathname: service.dirs?.resourcePacksDir,
            }).then().catch
          }
          primary
        >
      ...
      {service.resourcepacks.map((value, index) => (
        <ListTile
      ...
      {service.resourcepacks.length === 0 && <p>No Items.</p>}
    </div>
  );
}
